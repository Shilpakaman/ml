...
I=imread('medical dataset/x-ray2 axillary-and-frontal-sinusitis.jpg');
...
subplot(2,3,1),imshow(Img),title('Original X-ray image');
...
imwrite(GN,'D:\Matlab basics\resized images\XGNI.jpg');
imwrite(PN,'D:\Matlab basics\resized images\XPNI.jpg');
imwrite(SPN,'D:\Matlab basics\resized images\XSPNI.jpg');
imwrite(SN,'D:\Matlab basics\resized images\XSNI.jpg');
