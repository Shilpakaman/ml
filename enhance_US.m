...
I=imread('resized images/US2 placenta-accreta-3_output.jpg');
Img=rgb2gray(I);
%----uniform background
se=strel('disk',15);
bg=imopen(Img,se);
...
subplot(2,3,1),imshow(Img),title('Original US image');
...
imwrite(GN,'D:\Matlab basics\resized images\UGNI.jpg');
imwrite(PN,'D:\Matlab basics\resized images\UPNI.jpg');
imwrite(SPN,'D:\Matlab basics\resized images\USPNI.jpg');
imwrite(SN,'D:\Matlab basics\resized images\USNI.jpg');
